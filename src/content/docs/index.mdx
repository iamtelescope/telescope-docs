...
Welcome to **Telescope** project documentation. Current version is **0.0.27** ([changelog](/changelog)).
...
Pull the version `0.0.27` Docker image from GitHub Container Registry:

```sh
docker pull ghcr.io/iamtelescope/telescope:0.0.27
```
...
docker run \
    ...
    --network host \
    ghcr.io/iamtelescope/telescope:0.0.27
```
