...
Welcome to **Telescope** project documentation. Current version is **0.0.26** ([changelog](/changelog)).

Telescope is a web application that provides an intuitive interface for exploring log data. It supports multiple data sources, including **[ClickHouse](https://github.com/ClickHouse/ClickHouse)**, **[StarRocks](https://github.com/StarRocks/starrocks)**, **[Docker](https://www.docker.com/)**, and **[Kubernetes](https://kubernetes.io/)**. Users can configure connections, filter and search logs, and build visualizations through a unified and user-friendly interface.
...
Pull the version `0.0.26` Docker image from GitHub Container Registry:

```sh
docker pull ghcr.io/iamtelescope/telescope:0.0.26
```
...
docker run \
    ...
    --network host \
    ghcr.io/iamtelescope/telescope:0.0.26
```
