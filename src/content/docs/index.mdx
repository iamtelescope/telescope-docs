...
Pull the version `0.0.23` Docker image from GitHub Container Registry:

```sh
docker pull ghcr.io/iamtelescope/telescope:0.0.23
```
...
docker run \
    ...
    --network host \
    ghcr.io/iamtelescope/telescope:0.0.23
```
