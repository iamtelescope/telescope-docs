...
Welcome to **Telescope** project documentation. Current version is **0.0.25** ([changelog](/changelog)).
...
Pull the version `0.0.25` Docker image from GitHub Container Registry:

```sh
docker pull ghcr.io/iamtelescope/telescope:0.0.25
```
...
docker run \
    ...
    --network host \
    ghcr.io/iamtelescope/telescope:0.0.25
```
